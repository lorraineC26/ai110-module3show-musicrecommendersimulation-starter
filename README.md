...
**MoodMatch 1.0** is a content-based music recommender built for classroom exploration.

It scores a catalog of 20 songs against a user's genre, mood, energy, and acoustic preferences. Each song gets a total score out of 4.5 points. The top five highest-scoring songs are returned as recommendations.

The project includes a working scoring system, six edge-case user profiles tested across multiple experiments, and a full model card documenting how the system works, where it fails, and what could be improved.
...
For more about my reflection, please see the [Model Card](model_card.md).
